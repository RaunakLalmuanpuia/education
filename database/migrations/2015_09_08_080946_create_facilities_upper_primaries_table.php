...
class CreateFacilitiesUpperPrimariesTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('facilities_upper_primaries', function (Blueprint $table) {
            $table->increments('id');
    ...
    {
        Schema::drop('facilities_upper_primaries');
    }
}
