...
class CreateHigherSecondaryResultByPercentagesTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('higher_secondary_result_by_percentages', function (Blueprint $table) {
            $table->increments('id');
    ...
    {
        Schema::drop('higher_secondary_result_by_percentages');
    }
}
