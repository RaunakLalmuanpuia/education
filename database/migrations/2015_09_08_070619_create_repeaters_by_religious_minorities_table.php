...
class CreateRepeatersByReligiousMinoritiesTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('repeaters_by_religious_minorities', function (Blueprint $table) {
            $table->increments('id');
    ...
    {
        Schema::drop('repeaters_by_religious_minorities');
    }
}
