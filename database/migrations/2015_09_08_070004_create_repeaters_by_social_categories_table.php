...
class CreateRepeatersBySocialCategoriesTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('repeaters_by_social_categories', function (Blueprint $table) {
            $table->increments('id');
    ...
    {
        Schema::drop('repeaters_by_social_categories');
    }
}
